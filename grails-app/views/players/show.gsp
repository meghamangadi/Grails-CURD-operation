...
<html>
    ...
    <body>
        ...
        <div id="show-players" class="content scaffold-show" role="main">
            ...
            <f:display bean="players" />
            <g:form resource="${this.players}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.players}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
